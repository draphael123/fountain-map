...
export const STATE_RULES_ROWS: StateRuleRow[] = [
  { stateId: "AK", stateLabel: 'Alaska', compact: 'No', operational: 'No', requiredSteps: 'N/A', deaCsrs: 'Yes', cpaRequired: 'No', notes: 'MD Only' },
  ...
  { stateId: "AR", stateLabel: 'Arkansas', compact: 'Yes', operational: 'No', requiredSteps: 'NP → Independent → Prescriptive authority', deaCsrs: 'No', cpaRequired: 'Conditional', notes: 'Async/Non Controlled' },
  ...
  { stateId: "CT", stateLabel: 'Connecticut', compact: 'No', operational: 'No', requiredSteps: 'NP', deaCsrs: 'No', cpaRequired: 'No', notes: 'Async/Non Controlled' },
  { stateId: "DC", stateLabel: 'Washington D.C.', compact: 'No', operational: 'No', requiredSteps: 'N/A', deaCsrs: 'No', cpaRequired: 'No', notes: '' },
  { stateId: "DE", stateLabel: 'Delaware', compact: 'No', operational: 'No', requiredSteps: 'NP', deaCsrs: 'No', cpaRequired: 'No', notes: 'NON CONTROLLED STATE, Async Only (No CSR, DEA or PMP). When you get an APRN license in DE (which includes NPs), you are automatically granted prescriptive authority.' },
  ...
  { stateId: "KY", stateLabel: 'Kentucky', compact: 'Yes', operational: 'Yes', requiredSteps: 'NP → Prescriptive authority', deaCsrs: 'No', cpaRequired: 'Yes', notes: 'No CSRs needed. Fountain NPs do not prescribe in KY.' },
  ...
  { stateId: "MD", stateLabel: 'Maryland', compact: 'Yes', operational: 'Yes', requiredSteps: 'NP → CSR → PMP', deaCsrs: 'Yes', cpaRequired: 'No', notes: 'Schedule 3, 4, 5. State DEA specific.' },
  ...
  { stateId: "ND", stateLabel: 'North Dakota', compact: 'Yes', operational: 'Yes', requiredSteps: 'NP → PMP', deaCsrs: 'No', cpaRequired: 'No', notes: '' },
  { stateId: "NE", stateLabel: 'Nebraska', compact: 'Yes', operational: 'Yes', requiredSteps: 'NP → PMP', deaCsrs: 'No', cpaRequired: 'No', notes: '' },
  { stateId: "NH", stateLabel: 'New Hampshire', compact: 'No', operational: 'No', requiredSteps: 'NP → Non Controlled State', deaCsrs: 'No', cpaRequired: 'Yes', notes: 'Async/non controlled for NP\'s' },
  ...
  { stateId: "OH", stateLabel: 'Ohio', compact: 'Yes', operational: 'Yes', requiredSteps: 'NP → PMP → CPA', deaCsrs: 'No', cpaRequired: 'Yes', notes: 'CPA needed' },
  { stateId: "OK", stateLabel: 'Oklahoma', compact: 'No', operational: 'No', requiredSteps: 'NP, Independent P.A → NON CONTROLLED STATE', deaCsrs: 'No', cpaRequired: 'Conditional', notes: 'Async only' },
  ...
  { stateId: "SC", stateLabel: 'South Carolina', compact: 'Yes', operational: 'No', requiredSteps: 'N/A', deaCsrs: 'No', cpaRequired: 'Yes', notes: 'MD only' },
  ...
  { stateId: "UT", stateLabel: 'Utah', compact: 'Yes', operational: 'Yes', requiredSteps: 'NP → CSR → DEA → PMP', deaCsrs: 'Yes', cpaRequired: 'No', notes: 'Schedule 3, 4, 5. State DEA specific.' },
