...
export const ASYNC_TIERS = {
  ...
  tier2: ['OR', 'ID', 'WY', 'UT', 'AZ', 'NM', 'CO', 'ND', 'SD', 'TX', 'IA', 'WI', 'IN', 'KY', 'VT', 'ME', 'MA', 'NJ', 'VA', 'TN', 'NC', 'MD'],
};
...
export const SERVICE_AVAILABILITY: Record<ServiceType, string[]> = {
  ...
  // 34 states active (12 Tier 1 + 22 Tier 2)
  Async: [
    // Tier 1 (12 states)
    'WA', 'CA', 'NV', 'MT', 'NE', 'MN', 'IL', 'MI', 'OH', 'PA', 'NY', 'FL',
    // Tier 2 (22 states)
    'OR', 'ID', 'WY', 'UT', 'AZ', 'NM', 'CO', 'ND', 'SD', 'TX', 'IA', 'WI', 'IN', 'KY', 'VT', 'ME', 'MA', 'NJ', 'VA', 'TN', 'NC', 'MD'
  ],
};
